...
SbNetworkSystemLocal::SbNetworkSystemLocal(SbSystem &aSystem, SbNetworkImpl &aImpl) : mSystem(aSystem), mImpl(aImpl){}

void SbNetworkSystemLocal::Init()
{
	mSystem.Printf("%s\n", __PRETTY_FUNCTION__);
...
void SbNetworkSystemLocal::Shutdown()
{
	mImpl.Shutdown();
};
...
========================
*/
bool SbNetworkSystemLocal::StringToNetAdr(const char *asNetAdr, SbNetAdr &aOutNetAdr, bool abDoDNSResolve)
{
	sockaddr_in sadr{};
...
========================
*/
bool SbNetworkSystemLocal::Net_StringToSockaddr( const char* s, sockaddr_in* sadr, bool doDNSResolve )
{
